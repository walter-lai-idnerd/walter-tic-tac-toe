...
2. **Board**: The game uses a 3×3 grid with 9 empty cells
...
3. Once a move is made, it cannot be changed
...
The game automatically restarts after:
- A player wins (3 second delay)
- A tie occurs (3 second delay)

All cells reset to empty, and Player 1 (X) goes first again.
